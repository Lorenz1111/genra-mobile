...
export default function SetupProfileScreen() {
  ...
  return (
    ...
    >
      {/* SENIOR DEV FIX: Tinanggal na natin yung Back Button dito! */}

      {/* Skip Button - Iniwan natin para hindi sapilitan ang pag-upload */}
      <Pressable
        onPress={handleSkip}
      ...
      <View className="px-8 gap-8 pt-32 pb-10 flex-1 justify-between">
        <View>
          ...
          <View className="gap-4">
            <Pressable
              className="flex-row items-center justify-center bg-gray-50 border border-gray-200 rounded-2xl py-4 active:bg-gray-100"
        ...
        {avatarUri && (
          <View className="mt-auto pt-8">
            <Pressable
              className="flex-row items-center justify-center rounded-full bg-primary px-5 py-4 active:bg-blue-700"
