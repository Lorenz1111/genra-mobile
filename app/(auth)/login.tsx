...
import {
  ...
  Text,
  View,
} from "react-native"; // SENIOR DEV FIX: Idinagdag ang Alert dito!
  ...
  return (
    ...
    >
      <View className="px-8 gap-8 py-10">
        <Image
          source={require("../../assets/images/genra-logo.png")}
        ...
        <View className="gap-2">
          ...
          <View className="flex-row items-center justify-between mt-2">
            ...
            >
              <View
                className={`w-5 h-5 rounded border items-center justify-center mr-2 ${rememberMe ? "bg-primary border-primary" : "border-gray-300"}`}
              >
                {rememberMe && (
        ...
        <View className="flex-row justify-center items-center mt-2">
          ...
          <Link href="/(auth)/register" asChild>
            <Pressable>
              <Text className="text-primary font-bold"> Sign up for free</Text>
            </Pressable>
          </Link>
        </View>
      </View>
