...
export default function EditProfileScreen() {
  ...
  const handleSave = async () => {
    ...
    if (error) {
      Alert.alert(
        "Error",
        "Could not update profile. Make sure your username is unique.",
      );
      console.error(error);
    } else {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      >
        {/* --- FULL NAME FIELD --- */}
        <View className="mb-6">
          <Text className="text-xs font-bold text-slate-500 mb-2 uppercase tracking-widest">
            Full Name
          </Text>
          <TextInput
        ...
        <View className="mb-6">
          ...
          <View className="relative justify-center">
            <TextInput
              ...
              } // Bawal space sa username
            />
            <Text className="absolute left-4 text-slate-400 text-base font-medium">
              @
            </Text>
          ...
          {usernameStatus === "taken" && (
            <Text className="text-[11px] text-red-500 mt-1.5 font-bold ml-1">
          ...
          {usernameStatus === "available" && (
            <Text className="text-[11px] text-emerald-500 mt-1.5 font-bold ml-1">
